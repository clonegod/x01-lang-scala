...
object TcpClient extends App {
  val system = ActorSystem("schoolClientSystem")
  val endpoint = new InetSocketAddress("127.0.0.1", 11111)
  val clientListener = system.actorOf(ClientListener.props, "school-client-listener")
  val clientRef = system.actorOf(Client.props(endpoint, clientListener), "school-client")
